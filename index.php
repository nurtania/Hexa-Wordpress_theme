            ...
            <main class="col-xl-8 col-lg-8 col-md-7 blog-area">
                ...
                <div class="recent-blogs blog-grid row">
                    ...
                    <article class="card single-blog text-center col-lg-6">
                        <mark class="catagory">Fashion</mark>
                        <h2 class="card-title h1">A Fashion Girl Pose in a Mustard field</h2>
                        <!-- Blog Content-->
                        <div class="blgo-content">
                            <a href="#"><img class="card-img rounded-0" src="assets/img/blog/2.jpg" alt="Blog Image"></a>
                            <span class="posted-date">26 Jan, 2016</span>
                        </div>
                        <!-- Card Body -->
                        <div class="card-body p-0">
                            ...
                            <a href="blog_details_gallery.html" class="read-more double-line">read more</a>
                            <!-- Card Footer -->
                        </div>
                        <div class="card-footer border-0 p-0 bg-white">
                            <div class="share-icons">
                    ...
                    <article class="card single-blog text-center col-lg-6">
                        <mark class="catagory">Fashion</mark>
                        <h2 class="card-title h1">A beautiful Women See Her Mobile Phone</h2>
                        <!-- Blog Content-->
                        <div class="blgo-content">
                            <a href="#"><img class="card-img rounded-0" src="assets/img/blog/3.jpg" alt="Blog Image"></a>
                            <span class="posted-date">26 Jan, 2016</span>
                        </div>
                        <!-- Card Body -->
                        <div class="card-body p-0">
                    ...
                    <article class="card single-blog no-image-post text-center col-lg-6">
                        <div class="inner-wrap">
                            <mark class="catagory">Fashion</mark>
                            <h2 class="card-title h1">There are no Image in This Post</h2>
                            <!-- Blog Content-->
                            <div class="blgo-content">
                                <span class="posted-date">26 Jan, 2016</span>
                            </div>
                            ...
                            <div class="card-body p-0">
                                <span class="posted-by">Posted By <mark class="admin">Admin</mark></span>
                                <p class="card-text">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry</p>
                                <a href="standard_blog_detail.html" class="read-more double-line">read more</a>
                                <!-- Card Footer -->
                            </div>
                            <div class="card-footer border-0 p-0 bg-white">
                    ...
                    <article class="card single-blog text-center col-lg-6">
                        <mark class="catagory">Fashion</mark>
                        <h2 class="card-title h1">Wooden Picnic Seating Area in the Middle of Mountains</h2>
                        <!-- Blog Content-->
                        <div class="blgo-content">
                            <a href="#"><img class="card-img rounded-0" src="assets/img/blog/5.jpg" alt="Blog Image"></a>
                            <span class="posted-date">26 Jan, 2016</span>
                        </div>
                        <!-- Card Body -->
                        <div class="card-body p-0">
                    ...
                    <article class="card single-blog text-center video-post col-lg-6">
                        <mark class="catagory">Travel</mark>
                        <h2 class="card-title h1">This is a Travel video post When I Traveled in USA</h2>
                        <!-- Blog Content-->
                        <div class="blgo-content">
                        ...
                        <div class="card-body p-0">
                            <span class="posted-by">Posted By <mark class="admin">Admin</mark></span>
                            <p class="card-text">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy </p>
                            <a href="blog_details_video.html" class="read-more double-line">read more</a>
                            <!-- Card Footer -->
                        </div>
                        <div class="card-footer border-0 p-0 bg-white">
                            <div class="share-icons">
                    ...
                    <article class="card single-blog slider-blog text-center col-lg-6 ">
                        ...
                        <h2 class="card-title h1">Water Lilies Stands In a Canel Water</h2>
                        <!-- Blog Content-->
                        <div class="blgo-content">
                        ...
                        <div class="card-body p-0">
                            <span class="posted-by">Posted By <mark class="admin">Admin</mark></span>
                            <p class="card-text">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy </p>
                            <a href="blog_detail_image_slider.html" class="read-more double-line">read more</a>
                            <!-- Card Footer -->
                        </div>
                        <div class="card-footer border-0 p-0 bg-white">
                            <div class="share-icons">
                    ...
                    <article class="card single-blog text-center col-lg-6">
                        <mark class="catagory">Life Style</mark>
                        <h2 class="card-title h1">This Is a Audio Post</h2>
                        <!-- Blog Content-->
                        <div class="blgo-content">
                            <a href="#"><img class="card-img rounded-0" src="assets/img/blog/8.jpg" alt="Blog Image"></a>
                            <span class="posted-date">26 Jan, 2016</span>
                        </div>
                        <!-- Card Body -->
                        <div class="card-body p-0">
                            <span class="posted-by">Posted By <mark class="admin">Admin</mark></span>
                            <p class="card-text">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy </p>
                            <a href="blog_details_audio.html" class="read-more double-line">read more</a>
                            <!-- Card Footer -->
                        </div>
                        <div class="card-footer border-0 p-0 bg-white">
                            <div class="share-icons">
